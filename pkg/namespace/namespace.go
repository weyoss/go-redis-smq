...
//
// A namespace is a logical isolation boundary that contains queues and exchanges.
// Namespace names are validated using Redis key rules (lowercase, letter-first,
